...
with open("processed_data/x_train.pkl", "wb") as file:
    pickle.dump(x_train, file)
print("x_train saved to 'x_train.pkl'.")

with open("processed_data/y_train.pkl", "wb") as file:
    pickle.dump(y_train, file)
print("y_train saved to 'y_train.pkl'.")

# Save test data to files
with open("processed_data/x_test.pkl", "wb") as file:
    pickle.dump(x_test, file)
print("processed_data/x_test saved to 'x_test.pkl'.")

with open("processed_data/y_test.pkl", "wb") as file:
...
tokenizer.word_index = word_to_id  # Use the vocabulary built earlier
...
# Save word_to_id
with open("embedding_layer/word_to_id.pkl", "wb") as file:
    pickle.dump(word_to_id, file)
print("word_to_id saved to 'word_to_id.pkl'.")
...
word2vec_model_path = "embedding_layer/glove-twitter-200.model"
...
lstm_model.save('review_analysis_model.h5')
print("Model saved as 'lstm_model.keras'.")
...
while True:
    ...
    if user_input.lower() == 'exit':
        ...
        break
    sentiment = lstm_predict(user_input)